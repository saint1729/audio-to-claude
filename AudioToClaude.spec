...
a = Analysis(
    ...
    binaries=[],
    datas=[
        ('assets/xterm.js', 'assets'),
        ('assets/xterm.css', 'assets'),
        ('assets/xterm-addon-fit.js', 'assets'),
        ('assets/markdown-it.min.js', 'assets'),
        ('assets/mermaid.min.js', 'assets'),
        ('assets/highlight.min.js', 'assets'),
        ('assets/github.min.css', 'assets'),
